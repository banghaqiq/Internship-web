    ...
    <div class="container">
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <h3 class="mb-4">Pesan Email </h3>
                <p class="mb-4">jika anda memilaiki kendala dalam website kami, anda bisa mengirim pesan kepada developer kami melalui Email yang tertara disamping.</p>
                <form>
                    <div class="row g-3">
                        <div class="col-md-6">
