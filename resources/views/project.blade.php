 ...
 <div class="row">
  <div class="col-6">
   <div class="card border border-primary border-3">
    <div class="card-header bg-primary fw-bold text-light" align="center" id="hdr" >{{ __('Halaman Project') }}</div>
     ...
     <form class="row g-3" action="" method="POST">
      <div class="col-md-12">
       ...
       <div class="col-md-12">
        ...
        <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" class="form-control border border-primary bg-info bg-opacity-10 border-2 fw-semibold" placeholder="Masukkan Deskripsi"></textarea>
       </div>
       <div class="col-md-12">
